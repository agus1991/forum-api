...
describe('ThreadRepositoryPostgres', () => {
  ...
  describe('addThread', () => {
    it('should persist new thread and return added thread correctly', async () => {
      ...
      //action
     // await repository.addThread(newThread);
      const addedThread = await repository.addThread(newThread);
      //assert
     // expect(addThread.id).toEqual('thread-123');
     // expect(addThread.title).toEqual(newThread.title);
     // expect(addThread.owner).toEqual(newThread.owner);
